Public Class Encryption
    Private cryptiServiceProvioder As System.Security.Cryptography.RNGCryptoServiceProvider
    Public Shared Function HashString(str As String) As String
        Return EncryptString(str)
    End Function

    Public Shared Function GenerateSalt() As String
        Using cryptiServiceProvioder As New System.Security.Cryptography.RNGCryptoServiceProvider
            Dim sb As New System.Text.StringBuilder()
            Dim data As Byte() = New Byte(4) {}
            For i = 0 To 6
                cryptiServiceProvioder.GetBytes(data)
